            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Biodata Daftar Ulang</h6>
                  <button type="button" class="btn btn-success mb-2" onclick="window.history.back()">Kembali</button>            
                </div>
                <?php 
            echo form_open('home/daftar_ulang2');
            ?> 
                <div class="container">
                <div class="row">
                <div class="col-md-8">
                <div class="card-body">
                <div class="row">
                <input type="hidden" id="no_pendaftaran" name="no_pendaftaran" value="<?= $mahasiswa['no_pendaftaran']?>">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Status</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                      <?php if($mahasiswa['mahasiswa_level'] == "aktif"){
                                echo "LULUS";
                      }else{  
                                echo "TIDAK LULUS";                    
                      }
                ...
                <div class="input-group-btn">
                      <button class="btn btn-primary" type="submit" name="submit">Daftar Ulang</button>
                    </div>
            </div>
              <!-- End Form -->
